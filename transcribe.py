...
def transcribe_file(model_file, flac_paths, save_path, sequence_length,
    ...
    for flac_path in flac_paths:
        ...
        audio = load_and_process_audio(flac_paths, sequence_length, device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_file', type=str, default='E:/xiaozhe/onsets-and-frames-master/runs/transcriber-40000-yuanma/model-40000.pt')
    parser.add_argument('--flac_paths', type=str, nargs='+', default='E:/xiaozhe/onsets-and-frames-master/data/MAPS_MUS/flac/MAPS_MUS-bk_xmas1_ENSTDkAm.flac')
